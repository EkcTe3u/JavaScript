'use strict';
// _[Идентификаторы: переменные и константы](https://www.youtube.com/watch?v=fb318yXGwxo&list=PLpmhTzMVLuROAIey9vW3pyRSpHfknLssu&index=2)_
// global const
...
// bad practice
let total = 100; // can be changed by other scripts/code
console.log({total});
total = "example"
console.log({total})
